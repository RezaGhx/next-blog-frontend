        ...
        <div className={'bg-white rounded-3xl px-4 flex items-center'}>
          <div className={'flex gap-x-2 items-center ml-4'}>
            ...
            <ul className={'flex gap-x-4 items-center'}>
              <li className={'cursor-pointer text-gray-700 py-4'}>پربازدیدترین</li>
              <li className={'cursor-pointer text-gray-700 py-4'}>محبوبترین</li>
              <li className={'cursor-pointer text-gray-700 py-4'}>جدیدترین</li>
            </ul>
        </div>
      </div>
